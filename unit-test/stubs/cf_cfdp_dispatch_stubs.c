...
{
    UT_GenStub_AddParam(CF_CFDP_R_DispatchRecv, CF_Transaction_t *, txn);
...
{
    UT_GenStub_AddParam(CF_CFDP_RxStateDispatch, CF_Transaction_t *, txn);
...
{
    UT_GenStub_AddParam(CF_CFDP_S_DispatchRecv, CF_Transaction_t *, txn);
