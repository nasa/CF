...
/* NOTE: Test_CF_CList_Traverse_CanActuallyGet_n_next_NotEqTo_nn_ButOnlyWithAn_fn_ThatForcesIt may need redesigned, or maybe the production code */
...
void Test_CF_CList_Traverse_WhenListIsManyNodesErrorIn_fn_Call(void)
{
    ...
    UtAssert_True(context_Dummy_clist_fn_t[0].context ==  arg_context, "context_Dummy_clist_fn_t[0].context ==  arg_context");

    clist_node expected_node = arg_start->next;
    for(i = 1; i <= error_location; ++i)
    {
        UtAssert_True(context_Dummy_clist_fn_t[i].node ==  expected_node, "context_Dummy_clist_fn_t[i].node ==  expected_node");
        UtAssert_True(context_Dummy_clist_fn_t[i].context ==  arg_context, "context_Dummy_clist_fn_t[i].context ==  arg_context");
...
void Test_CF_CList_Traverse_R_PassedIn_end_IsNotTheOnlyNode_fn_Returned_non0_Original_end_UsedLast(void)
{
    ...
    UtAssert_True(context_Dummy_clist_fn_t[1].context ==  arg_context, "context_Dummy_clist_fn_t[1].context ==  arg_context");
...
{    
    UtTest_Add(Test_CF_CList_InitNode_PointNodeToItselfAsNextAndPrev, 
...
{    
    UtTest_Add(Test_CF_CList_InsertFront_AssertsBecauseHeadIs_NULL, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CList_InsertFront_AssertsBecauseNodePrevDoesNotPointToItself, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_CList_InsertFront_AssertsBecauseNodePrevDoesNotPointToItself");    
    UtTest_Add(Test_CF_CList_InsertFront_InsertNodeIntoEmptyList, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_CList_InsertFront_InsertNodeIntoEmptyList");    
    UtTest_Add(Test_CF_CList_InsertFront_WhenHeadIsOnlyNodeAndTheyPointToEachOtherInsertNode, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
...
{    
    ...
    UtTest_Add(Test_CF_CList_InsertBack_AssertsBecauseNodeIs_NULL, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_CList_InsertBack_AssertsBecauseNodeIs_NULL");    
    UtTest_Add(Test_CF_CList_InsertBack_AssertsBecauseNodeNextDoesNotPointToItself, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_CList_InsertBack_AssertsBecauseNodeNextDoesNotPointToItself");    
    UtTest_Add(Test_CF_CList_InsertBack_AssertsBecauseNodePrevDoesNotPointToItself, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_CList_InsertBack_AssertsBecauseNodePrevDoesNotPointToItself");    
    ...
    UtTest_Add(Test_CF_CList_InsertBack_WhenHeadIsOnlyNodeAndTheyPointToEachOtherInsertNode, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_CList_InsertBack_WhenHeadIsOnlyNodeAndTheyPointToEachOtherInsertNode");    
...
{    
    UtTest_Add(Test_CF_CList_Pop_AssertsBecause_head_Is_NULL, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_CList_Pop_AssertsBecause_head_Is_NULL"); 
    UtTest_Add(Test_CF_CList_Pop_WhenListIsEmptySuccessReturn_NULL, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_CList_Pop_WhenListIsEmptySuccessReturn_NULL"); 
    UtTest_Add(Test_CF_CList_Pop_WhenItIsOnlyNodePopHeadNodeAndReturn_head_, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_CList_Pop_WhenItIsOnlyNodePopHeadNodeAndReturn_head_");  
...
{
    UtTest_Add(Test_CF_CList_Remove_AssertsBecauseHeadIs_NULL, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_CList_Remove_AssertsBecauseHeadIs_NULL");  
    UtTest_Add(Test_CF_CList_Remove_AssertsBecauseNodeIs_NULL, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_CList_Remove_AssertsBecauseNodeIs_NULL");
    UtTest_Add(Test_CF_CList_Remove_AssertsBecauseHeadPointedAtValueIs_NULL, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_ClistRemove_WhenOnlyNodeSetHeadTo_NULL, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_ClistRemove_WhenOnlyNodeSetHeadTo_NULL");
    UtTest_Add(Test_CF_ClistRemove_WhenOnlyTwoNodesAndLastIsRemovedSetHeadToPointToItself, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_ClistRemove_WhenOnlyTwoNodesAndLastIsRemovedSetHeadToPointToItself");
    UtTest_Add(Test_CF_ClistRemove_RemovingHeadSetSecondNodeToHeadAndUpdateLastNode, 
         cf_clist_tests_Setup, cf_clist_tests_Teardown, 
         "Test_CF_ClistRemove_RemovingHeadSetSecondNodeToHeadAndUpdateLastNode");
    UtTest_Add(Test_CF_ClistRemove_RemovingLastPointHeadAndNextToLastToEachOther, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
      "Test_CF_ClistRemove_RemovingLastPointHeadAndNextToLastToEachOther");
...
{
    UtTest_Add(Test_CF_CList_InsertAfter_AssertsBecause_head_Is_NULL, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CList_InsertAfter_AssertsBecauseValueAt_head_Is_NULL, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
      "Test_CF_CList_InsertAfter_AssertsBecause_head_Is_NULL"); 
    UtTest_Add(Test_CF_CList_InsertAfter_AssertsBecause_start_Is_NULL, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
      "Test_CF_CList_InsertAfter_AssertsBecause_head_Is_NULL"); 
    UtTest_Add(Test_CF_CList_InsertAfter_AssertsBecause_start_IsEqTo_after, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
      "Test_CF_CList_InsertAfter_AssertsBecause_head_Is_NULL");  
    UtTest_Add(Test_CF_CList_InsertAfter_WhenOnlyOneNodeSuccess_after_IsInsertedAfter_start, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
      "Test_CF_CList_InsertAfter_WhenOnlyOneNodeSuccess_after_IsInsertedAfter_start");
    UtTest_Add(Test_CF_CList_InsertAfter_WhenAnyNodeSuccess_after_IsInsertedAfter_start, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
...
{
    UtTest_Add(Test_CF_CList_Traverse_When_start_Is_NULL_DoNothing, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
      "Test_CF_CList_Traverse_When_start_Is_NULL_DoNothing");
    UtTest_Add(Test_CF_CList_Traverse_WhenListIsMoreThanOneNodeErrorOutFirst_fn_CallFails, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
      "Test_CF_CList_Traverse_WhenListIsMoreThanOneNodeErrorOutFirst_fn_CallFails");   
    UtTest_Add(Test_CF_CList_Traverse_WhenListIsOneNodeSuccess, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CList_Traverse_WhenListIsManyNodesSuccess, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
...
{
    UtTest_Add(Test_CF_CList_Traverse_R_When_end_Is_NULL_DoNothing, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
      "Test_CF_CList_Traverse_R_When_end_Is_NULL_DoNothing");
    UtTest_Add(Test_CF_CList_Traverse_R_When_end_prev_Is_NULLDoNothing, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
      "Test_CF_CList_Traverse_R_When_end_prev_Is_NULLDoNothing");
    UtTest_Add(Test_CF_CList_Traverse_R_WhenListIsMoreThanOneNodeErrorOutFirst_fn_CallFails, 
      cf_clist_tests_Setup, cf_clist_tests_Teardown, 
      "Test_CF_CList_Traverse_R_WhenListIsMoreThanOneNodeErrorOutFirst_fn_CallFails");  
