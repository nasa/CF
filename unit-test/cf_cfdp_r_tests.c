...
void Test_CF_CFDP_R_CheckCrc(void)
{
    ...
    UtAssert_UINT32_EQ(CF_AppData.hk.channel_hk[txn->chan_num].counters.fault.crc_mismatch, 1);
    ...
    UT_CF_AssertEventID(CF_EID_ERR_CFDP_R_CRC);
    UtAssert_UINT32_EQ(CF_AppData.hk.channel_hk[txn->chan_num].counters.fault.crc_mismatch, 2);
...
void Test_CF_CFDP_R2_Complete(void)
{
    ...
    UtAssert_UINT32_EQ(CF_AppData.hk.channel_hk[txn->chan_num].counters.fault.nak_limit, 1);
...
void Test_CF_CFDP_R_ProcessFd(void)
{
    ...
    UtAssert_UINT32_EQ(CF_AppData.hk.channel_hk[txn->chan_num].counters.recv.file_data_bytes, 100);
    ...
    UtAssert_UINT32_EQ(CF_AppData.hk.channel_hk[txn->chan_num].counters.recv.file_data_bytes, 200);
