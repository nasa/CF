...
{
    UT_Stub_CopyFromLocal(UT_KEY(DummyFunctionFor_CF_TraverseAllTransactions_),
      &t, sizeof(t));
    UT_Stub_CopyFromLocal(UT_KEY(DummyFunctionFor_CF_TraverseAllTransactions_),
...
void Test_cf_move_transaction_Call_CF_CList_InsertBack_AndSet_q_index_ToGiven_q(void)
{
    ...
    expected_insert_back_head = 
      &CF_AppData.engine.channels[arg_t->chan_num].qs[arg_q];
...
void Test_CF_CList_Remove_Ex_Call_CF_CList_Remove_AndDecrement_q_size(void)
{
    /* Arrange */
    channel_t*          arg_c = 
      &CF_AppData.engine.channels[Any_uint32_LessThan(CF_NUM_CHANNELS)];
    cf_queue_index_t    arg_index = Any_cf_queue_index_t();
...
void Test_CF_TraverseHistory_When_CF_WrappedWrite_FailsFirstCallReturn_CLIST_EXIT(void)
{
    ...
    UtAssert_True(EventID == CF_EID_ERR_CMD_WHIST_WRITE,
      "CFE_EVS_SendEvent event id is 0x%04X and should be 0x%04X (CF_EID_ERR_CMD_WHIST_WRITE)",
      EventID, CF_EID_ERR_CMD_WHIST_WRITE);
    UtAssert_True(arg_context->result == 1,
      "CF_TraverseHistory set context.result to %d and should be 1",
      arg_context->result);
...
void Test_CF_TraverseHistory_WhenBothWrappedWritesSuccessfulReturn_CLIST_CONT(void)
{
    ...
    UtAssert_True(arg_context->result == 0,
      "CF_TraverseHistory context.result is %d and should be 0",
      arg_context->result);
...
void Test_CF_WriteQueueDataToFile_Call_CF_CList_Traverse_AndReturn_arg_result(void)
{
    ...
    UT_SetDataBuffer(UT_KEY(CF_CList_Traverse), &context_clist_traverse,
      sizeof(context_clist_traverse), false);
...
void Test_CF_PrioSearch_When_t_PrioIsGreaterThanContextPrioReturn_CLIST_CONT(void)
{
    ...
    /* Assert */
    UtAssert_True(result == CLIST_CONT,
...
void Test_CF_InsertSortPrio_Call_CF_CList_InsertAfter_Ex_AndSet_q_index_To_q(void)
{
    ...
    UT_SetDataBuffer(UT_KEY(CF_CList_Traverse_R), &context_cf_clist_traverse_r,
      sizeof(context_cf_clist_traverse_r), false);
...
void Test_CF_TraverseAllTransactions__GetContainer_t_Call_args_fn_AndAdd_1_ToCounter(void)
{
    ...
    UT_SetDataBuffer(UT_KEY(DummyFunctionFor_CF_TraverseAllTransactions_), 
      &func_ptr_context, sizeof(func_ptr_context), false);
...
void Test_CF_TraverseAllTransactions_CallOtherFunction_CF_Q_RX_TimesAndReturn_args_counter(void)
{
    ...
    CF_TraverseAllTransactions_fn_t arg_fn = 
    ...
    CF_CList_Traverse_TRAVERSE_ALL_ARGS_T_context_t 
      contexts_cf_clist_traverse[expected_count];
    UT_SetDataBuffer(UT_KEY(CF_CList_Traverse), &contexts_cf_clist_traverse,
      sizeof(contexts_cf_clist_traverse), false);
...
{
    /* cf_dequeue_transaction tests */
    UtTest_Add(Test_cf_dequeue_transaction_AssertsBecause_t_IsNull, 
      cf_utils_tests_Setup, cf_utils_tests_Teardown, 
      "Test_cf_dequeue_transaction_AssertsBecause_t_IsNull");
    UtTest_Add(Test_cf_dequeue_transaction_AssertsBecause_t_chan_num_LessThan_CF_NUM_CHANNELS, 
      cf_utils_tests_Setup, cf_utils_tests_Teardown, 
    ...
    /* cf_move_transaction tests */
    UtTest_Add(Test_cf_move_transaction_AssertsBecause_t_IsNull, 
      cf_utils_tests_Setup, cf_utils_tests_Teardown, 
      "Test_cf_move_transaction_AssertsBecause_t_IsNull");
    UtTest_Add(Test_cf_move_transaction_AssertsBecause_t_chan_num_LessThan_CF_NUM_CHANNELS, 
      cf_utils_tests_Setup, cf_utils_tests_Teardown, 
      "Test_cf_move_transaction_AssertsBecause_t_chan_num_LessThan_CF_NUM_CHANNELS"); 
...
{
    UtTest_Add(Test_CF_InsertSortPrio_AssertsBecause_t_chan_num_LessThan_CF_NUM_CHANNELS, 
      cf_utils_tests_Setup, cf_utils_tests_Teardown, 
      "Test_CF_InsertSortPrio_AssertsBecause_t_chan_num_LessThan_CF_NUM_CHANNELS");  
