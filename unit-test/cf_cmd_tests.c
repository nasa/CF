...
void Test_CF_EnableEngineCmd_WithEngineEnableFailsSendEventAndIncrementErrCounter(void)
{
    /* Arrange */
    CF_EnableEngineCmd_t utbuf;
    uint16               initial_hk_err_counter = Any_uint16();
...
void Test_CF_DisableEngineCmd_WhenEngineDisabledAndIncrementErrCounterThenFail(void)
{
    /* Arrange */
    CF_DisableEngineCmd_t utbuf;
    uint16                initial_hk_err_counter = Any_uint16();
...
void add_CF_EnableEngineCmd_tests(void)
{
    ...
    UtTest_Add(Test_CF_EnableEngineCmd_WithEngineEnableFailsSendEventAndIncrementErrCounter, cf_cmd_tests_Setup,
...
void add_CF_DisableEngineCmd_tests(void)
{
    UtTest_Add(Test_CF_DisableEngineCmd_SuccessWhenEngineEnabledAndIncrementCmdCounter, cf_cmd_tests_Setup,
               cf_cmd_tests_Teardown, "Test_CF_DisableEngineCmd_SuccessWhenEngineEnabledAndIncrementCmdCounter");
    UtTest_Add(Test_CF_DisableEngineCmd_WhenEngineDisabledAndIncrementErrCounterThenFail, cf_cmd_tests_Setup,
               cf_cmd_tests_Teardown, "Test_CF_DisableEngineCmd_WhenEngineDisabledAndIncrementErrCounterThenFail");
}
