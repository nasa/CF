...
cfdp_send_ret_t Any_cfdp_send_ret_t(void)
{
...
cfdp_send_ret_t Any_cfdp_send_ret_t_ExceptThese(cfdp_send_ret_t exceptions[], uint8 num_exceptions)
{
    ...
    while (i != num_exceptions)
    {
        ...
        ** never really happen - so it is not that important for test code */
        ...
        {
            random_val = Any_uint8_LessThan(CF_SEND_FAILURE + 1);
            i = 0;
        }
        else
        {
...
cfdp_send_ret_t Any_cfdp_send_ret_t_Except(cfdp_send_ret_t exception)
{
  cfdp_send_ret_t  exceptions[1] = {exception};
...
void Test_CFDP_S_SendEof_When_flag_tx_crc_calc_Is_0_Call_CF_CRC_Finalize_AndSet_crc_calc_To_1_ReturnValueOfCallTo_CF_CFDP_SendEof(void)
{
    /* Arrange */
    ...
    UT_SetDataBuffer(UT_KEY(CF_CRC_Finalize), &context_CF_CRC_Finalize, 
      sizeof(context_CF_CRC_Finalize), false);
...
void Test_CF_CFDP_S2_SubstateSendEof_TriggerTickProcessing(void)
{
    ...
    UT_SetDataBuffer(UT_KEY(CF_InsertSortPrio), &context_CF_InsertSortPrio,
      sizeof(context_CF_InsertSortPrio), false);
    ...
    UtAssert_True(arg_t->flags.tx.ack_timer_armed == 1,
    ...
    UtAssert_True(arg_t->state_data.s.sub_state == SEND_WAIT_FOR_EOF_ACK,
      ...
      arg_t->state_data.s.sub_state, SEND_WAIT_FOR_EOF_ACK);
    UtAssert_True(arg_t->flags.tx.ack_timer_armed == 1,
      "t->flags.tx.ack_timer_armed is %d and should be 1",
      arg_t->flags.tx.ack_timer_armed);
...
void Test_CFDP_S_SendFileData_When_ph_Is_NULL_Return_0(void)
{
    ...
    UT_SetHandlerFunction(UT_KEY(CF_CFDP_ConstructPduHeader), Handler_CF_CFDP_ConstructPduHeader_ForceReturnOnly, &forced_return_CF_CFDP_ConstructPduHeader);

    /* Act */
    result = CF_CFDP_S_SendFileData(arg_t, arg_foffs, arg_bytes_to_read, arg_calc_crc);
    
    /* Assert */
    UtAssert_True(result == 0, "NULL ph caused return of %d and should be 0",
      result);
    UtAssert_STUB_COUNT(CF_WrappedLseek, 0);
} /* end Test_CFDP_S_SendFileData_When_ph_Is_NULL_Return_0 */

//NOTE:Test_CFDP_S_SendFileData sets bytes to read to chunk size if greater than chunk size not required for coverage but desired for completeness

void Test_CFDP_S_SendFileData_WhenCachedPosNotEq_foffs_CallTo_CF_WrappedLseek_Returns_status_NotEqTo_foffs_SendEventReturn_neg1(void)
{
    /* Arrange */
    cf_config_table_t     dummy_config_table;
    history_t             dummy_history;
    ...
    UtAssert_True(result == -1, 
      "Bad lseek caused return of %d and should be -1",
      result);
...
} /* end Test_CFDP_S_SendFileData_WhenCachedPosNotEq_foffs_CallTo_CF_WrappedLseek_Returns_status_NotEqTo_foffs_SendEventReturn_neg1 */
...
void Test_CFDP_S_SendFileData_CallTo_CF_WrappedRead_ReturnsValueNotEqTo_bytes_to_read_SendEventAndReturn_neg1(void)
{
    ...
    transaction_t*        arg_t = &dummy_t;
    uint32                arg_foffs = Any_uint32();
    uint32                arg_bytes_to_read = Any_uint16(); /* Any_uint16_Except(0) used to limit to same type as CF_AppData.config_table->outgoing_file_chunk_size */
    uint8                 arg_calc_crc = Any_uint8();
    pdu_header_t          dummy_ph;
    pdu_header_t*         forced_return_CF_CFDP_ConstructPduHeader = &dummy_ph;
    ...
    dummy_config_table.outgoing_file_chunk_size = arg_bytes_to_read; /* forces bytes_to_read to be eq to CF_AppData.config_table->outgoing_file_chunk_size (don't run if block) */
    CF_AppData.config_table = &dummy_config_table;
    arg_t->history = &dummy_history;
...
void Test_CFDP_S_SendFileData_Given_bytes_to_read_GreaterThan_outgoing_file_chunk_size_CallTo_CF_WrappedRead_ReturnsValueNotEqTo_bytes_to_read_SendEventAndReturn_neg1(void)
{
    /* Arrange */
    cf_config_table_t     dummy_config_table;
    history_t             dummy_history;
    ...
    transaction_t*        arg_t = &dummy_t;
    uint32                arg_foffs = Any_uint32();
    uint32                arg_bytes_to_read = Any_uint16_Except(0); /* Any_uint16_Except(0) used to limit to same type as CF_AppData.config_table->outgoing_file_chunk_size */
    uint8                 arg_calc_crc = Any_uint8();
    pdu_header_t          dummy_ph;
    pdu_header_t*         forced_return_CF_CFDP_ConstructPduHeader = &dummy_ph;
    ...
    dummy_config_table.outgoing_file_chunk_size = arg_bytes_to_read - 1; /* forces bytes_to_read to be greater than CF_AppData.config_table->outgoing_file_chunk_size (run if block) */
    CF_AppData.config_table = &dummy_config_table;
    ...
    UtAssert_StrCmp(context_CFE_EVS_SendEvent.Spec, expected_Spec,
      "CFE_EVS_SendEvent received expected Spec\n'%s' - Received\n'%s' - Expected", 
      context_CFE_EVS_SendEvent.Spec, expected_Spec);
} /* end Test_CFDP_S_SendFileData_Given_bytes_to_read_GreaterThan_outgoing_file_chunk_size_CallTo_CF_WrappedRead_ReturnsValueNotEqTo_bytes_to_read_SendEventAndReturn_neg1 */
...
void Test_CFDP_S_SendFileData_CallTo_CF_CFDP_SendFd_Returns_CF_SEND_NO_MSG_Return_0(void)
{
    ...
    context_CF_CFDP_SendFd.forced_return = CF_SEND_NO_MSG;
    ...
    UtAssert_True(result == 0,
      "CFDP_S_SendFileData returned %d and should be 0 (no bytes processed)",
      result);
    UtAssert_STUB_COUNT(CF_WrappedLseek, 0);
    UtAssert_STUB_COUNT(CF_WrappedRead, 1);
...
void Test_CFDP_S_SendFileData_CallTo_CF_CFDP_SendFd_Returns_CF_SEND_ERROR_SendEventAndReturn_neg1(void)
{
    ...
    context_CF_CFDP_SendFd.forced_return = CF_SEND_ERROR;
    UT_SetDataBuffer(UT_KEY(CF_CFDP_SendFd), &context_CF_CFDP_SendFd,
      sizeof(context_CF_CFDP_SendFd), false);
...
void Test_CFDP_S_SendFileData_CallTo_CF_CFDP_SendFd_ReturnsDontCareNoCallTo_CF_CRC_Digest_ReturnBytesToRead(void)
{
    ...
    UtAssert_True(result == expected_bytes_to_read,
      "CFDP_S_SendFileData returned %d and should be %d (bytes_to_read)",
      result, expected_bytes_to_read);
    UtAssert_STUB_COUNT(CF_WrappedLseek, 0);
    UtAssert_STUB_COUNT(CF_WrappedRead, 1);
    UtAssert_STUB_COUNT(CF_CFDP_SendFd, 1);
    UtAssert_STUB_COUNT(CFE_EVS_SendEvent, 0);
    UtAssert_STUB_COUNT(CF_CRC_Digest, 0);
    UtAssert_True(CF_AppData.hk.channel_hk[arg_t->chan_num].counters.sent.file_data_bytes == (uint64)(initial_file_data_bytes + (uint64)expected_bytes_to_read),
      "file_read is %lu and should be %u (bytes_to_read) more than %lu (value before call)",
      CF_AppData.hk.channel_hk[arg_t->chan_num].counters.sent.file_data_bytes, expected_bytes_to_read, initial_file_data_bytes);
...
void Test_CF_CFDP_S_SubstateSendFileData_CallTo_CFDP_S_SendFileData_Returns_0_DontCareSoDoNothing(void)
{
    ...
    uint8           initial_cc = Any_uint8_Except(CC_FILESTORE_REJECTION); /* TODO: any_condition_code_except would be more proper */
    ...
    UtAssert_True(arg_t->foffs == initial_foffs,
      "t->foffs is %u and should not have changed from %u (value before call)",
      arg_t->foffs, initial_foffs);
    UtAssert_True(arg_t->history->cc == initial_cc,
      "t->history->cc is %u and should be %u (unchanged)",
      arg_t->history->cc, initial_cc);
    UtAssert_True(arg_t->state_data.s.sub_state == initial_sub_state,
      "t->state_data.s.sub_state is %u and should be %u (unchanged)",
      arg_t->state_data.s.sub_state, initial_sub_state);
...
void Test_CF_CFDP_S_SubstateSendFileData_CallTo_CFDP_S_SendFileData_ReturnsGreaterThan_0_Update_t_foffs_NotEq_t_fsize_DoNotSet_sub_state(void)
{
    /* Arrange */
    history_t       dummy_history;
    transaction_t   dummy_t;
    ...
    /* Assert */
    UtAssert_True(arg_t->foffs == 1 + initial_foffs,
      "t->foffs is %u and should be 1 more than %u (value before call)",
      arg_t->foffs, initial_foffs);
    UtAssert_True(arg_t->history->cc == initial_cc,
      "t->history->cc is %u and should be %u (unchanged)",
      arg_t->history->cc, initial_cc);
    ...
    /* Assert unstubbable CF_CFDP_S_SendFileData */
    UtAssert_STUB_COUNT(CF_CFDP_ConstructPduHeader, 1);
} /* end Test_CF_CFDP_S_SubstateSendFileData_CallTo_CFDP_S_SendFileData_ReturnsGreaterThan_0_Update_t_foffs_NotEq_t_fsize_DoNotSet_sub_state */

void Test_CF_CFDP_S_SubstateSendFileData_CallTo_CFDP_S_SendFileData_ReturnsGreaterThan_0_Update_t_foffs_IsEqTo_t_fsize_Set_sub_state_To_SEND_EOF(void)
{
    /* Arrange */
    history_t       dummy_history;
    transaction_t   dummy_t;
    ...
    UtAssert_True(arg_t->foffs == dummy_bytes_received + initial_foffs,
      "t->foffs is %u and should be %u more than %u (value before call)",
      arg_t->foffs, dummy_bytes_received, initial_foffs);
    UtAssert_True(arg_t->history->cc == initial_cc,
      "t->history->cc is %u and should be %u (unchanged)",
      arg_t->history->cc, initial_cc);
    UtAssert_True(arg_t->state_data.s.sub_state == SEND_EOF,
      "t->state_data.s.sub_state is %u and should be %u (SEND_EOF)",
      arg_t->state_data.s.sub_state, SEND_EOF);
    /* Assert unstubbable CF_CFDP_S_SendFileData */
    UtAssert_STUB_COUNT(CF_CFDP_ConstructPduHeader, 1);
} /* end Test_CF_CFDP_S_SubstateSendFileData_CallTo_CFDP_S_SendFileData_ReturnsGreaterThan_0_Update_t_foffs_IsEqTo_t_fsize_Set_sub_state_To_SEND_EOF */

void Test_CF_CFDP_S_SubstateSendFileData_CallTo_CFDP_S_SendFileData_ReturnsLessThan_0_Set_cc_To_CC_FILESTORE_REJECTION_And_sub_state_To_SEND_EOF(void)
{
    /* Arrange */
    history_t       dummy_history;
    transaction_t   dummy_t;
    ...
    /* Assert unstubbable CF_CFDP_S_SendFileData */
    UtAssert_STUB_COUNT(CF_CFDP_ConstructPduHeader, 1);
} /* end Test_CF_CFDP_S_SubstateSendFileData_CallTo_CFDP_S_SendFileData_ReturnsLessThan_0_Set_cc_To_CC_FILESTORE_REJECTION_And_sub_state_To_SEND_EOF */
...
void Test_CF_CFDP_S_CheckAndRespondNak_FailsBecause_CF_CFDP_SendMd_Returns_CF_SEND_ERROR_Return_neg1(void)
{
    ...
    UT_SetDataBuffer(UT_KEY(CF_CFDP_SendMd), &context_CF_CFDP_SendMd,
      sizeof(context_CF_CFDP_SendMd), false);
    ...
    UtAssert_True(local_result == -1,
      "CF_CFDP_S_SendEof returned %d and should be -1",
      local_result);
...
void Test_CF_CFDP_S_CheckAndRespondNak_SuccessBecause_CF_CFDP_SendMd_Returns_CF_SEND_SUCCESS_Return_1(void)
{
    ...
    UT_SetDataBuffer(UT_KEY(CF_CFDP_SendMd), &context_CF_CFDP_SendMd,
      sizeof(context_CF_CFDP_SendMd), false);
    UT_SetDefaultReturnValue(UT_KEY(CF_CFDP_SendMd), CF_SEND_SUCCESS);
...
void Test_CF_CFDP_S_CheckAndRespondNak_DoesNothingBecause_CF_CFDP_SendMd_DoesNotReturn_CF_SEND_ERROR_Or_CF_SEND_SUCCESS_Return_1(void)
{
    /* Arrange */
    transaction_t     dummy_t;
    transaction_t*    arg_t = &dummy_t;
    cfdp_send_ret_t   exceptions[2] = {CF_SEND_ERROR, CF_SEND_SUCCESS};
    int               local_result;
    transaction_t*    context_CF_CFDP_SendMd;
    ...
    UtAssert_True(arg_t->flags.tx.md_need_send == 1,
      ...
      arg_t->flags.tx.md_need_send);
} /* end Test_CF_CFDP_S_CheckAndRespondNak_DoesNothingBecause_CF_CFDP_SendMd_DoesNotReturn_CF_SEND_ERROR_Or_CF_SEND_SUCCESS_Return_1 */
...
void Test_CF_CFDP_S_CheckAndRespondNak_CallTo_CF_Chunks_GetFirstChunkReturns_nonNULL_CallTo_CFDP_S_SendFileData_Returns_0_ThenReturn_0(void)
{
    ...
    /* Assert */
    UtAssert_True(local_result == 0,
      "CF_CFDP_S_CheckAndRespondNak returned %d and should be 0",
      local_result);
    UtAssert_STUB_COUNT(CF_CFDP_SendMd, 0);
    UtAssert_STUB_COUNT(CF_Chunks_GetFirstChunk, 1);
    UtAssert_ADDRESS_EQ(context_CF_Chunks_GetFirstChunk.chunks, &arg_t->chunks->chunks);
...
void Test_CF_CFDP_S_CheckAndRespondNak_CallTo_CF_Chunks_GetFirstChunkReturns_nonNULL_CallTo_CFDP_S_SendFileData_ReturnsLessThan_0_ThenReturn_neg1(void)
{
    /* Arrange */
    transaction_t     dummy_t;
    transaction_t*    arg_t = &dummy_t;
    ...
    UtAssert_STUB_COUNT(CF_CFDP_ConstructPduHeader, 1);
    UtAssert_STUB_COUNT(CF_WrappedLseek, 1);
} /* end Test_CF_CFDP_S_CheckAndRespondNak_CallTo_CF_Chunks_GetFirstChunkReturns_nonNULL_CallTo_CFDP_S_SendFileData_ReturnsLessThan_0_ThenReturn_neg1 */

void Test_CF_CFDP_S_CheckAndRespondNak_CallTo_CF_Chunks_GetFirstChunkReturned_nonNULL_CallTo_CFDP_S_SendFileData_ReturnsGreaterThan_0_ThenReturn_1(void)
{
    /* Arrange */
    transaction_t     dummy_t;
    transaction_t*    arg_t = &dummy_t;
    ...
    UtAssert_STUB_COUNT(CF_WrappedRead, 1);
    UtAssert_STUB_COUNT(CF_CFDP_SendFd, 1);
} /* end Test_CF_CFDP_S_CheckAndRespondNak_CallTo_CF_Chunks_GetFirstChunkReturned_nonNULL_CallTo_CFDP_S_SendFileData_ReturnsGreaterThan_0_ThenReturn_1 */

/* end CF_CFDP_S_CheckAndRespondNak tests */

/*******************************************************************************
**
**  CF_CFDP_S2_SubstateSendFileData tests (small) - no coverage (broken) - [unstubbables: CF_CFDP_S_CheckAndRespondNak, CF_CFDP_S_SubstateSendFileData, CF_CFDP_S_Reset]
**
*******************************************************************************/
...
void Test_CF_CFDP_S2_SubstateSendFileData_CallTo_CF_CFDP_S_CheckAndRespondNak_ReturnsPositiveValueDoNothing(void)
{
    ...
    CF_AppData.config_table->outgoing_file_chunk_size = 2; /* bytes_to_read < CF_AppData.config_table->outgoing_file_chunk_size */
    ...
    context_CF_CFDP_SendFd.forced_return = CF_SEND_SUCCESS; /* status == CF_SEND_SUCCESS */
...
void Test_CF_CFDP_S_SubstateSendMetadata_CallTo_OS_FileOpenCheck_Returns_OS_SUCCESS_Increment_fault_file_open(void)
{
    ...
    arg_t->history = &dummy_history;
    arg_t->history->cc = Any_uint8_Except(CC_FILESTORE_REJECTION); /* Setting arg_t->history->cc not required to set, but helps verify change */
    arg_t->fd = 0;
    ...
    UtAssert_StrCmp(context_CFE_EVS_SendEvent.Spec, expected_Spec,
      "CFE_EVS_SendEvent received expected Spec\n'%s' - Received\n'%s' - Expected", 
      context_CFE_EVS_SendEvent.Spec, expected_Spec);
    UtAssert_True(CF_AppData.hk.channel_hk[arg_t->chan_num].counters.fault.file_open == (uint16)(initial_fault_file_open + 1),
      "fault.file_open was incremented to %u and should be 1 more than %u (value before call)",
      CF_AppData.hk.channel_hk[arg_t->chan_num].counters.fault.file_open, initial_fault_file_open);
    UtAssert_True(arg_t->history->cc == CC_FILESTORE_REJECTION,
      "t->history->cc was set to %u and should be %u (CC_FILESTORE_REJECTION)",
      arg_t->history->cc, CC_FILESTORE_REJECTION);
...
void Test_CF_CFDP_S_SubstateSendMetadata_FirstCallTo_CF_WrappedLseek_Sets_status_LessThan_0_Increment_fault_file_seek(void)
{
    /* Arrange */
    history_t       dummy_history;
    transaction_t   dummy_t;
    ...
    /* Assert CF_CFDP_S_Reset */
    UtAssert_STUB_COUNT(CF_CFDP_ResetTransaction, 1);
} /* end Test_CF_CFDP_S_SubstateSendMetadata_FirstCallTo_CF_WrappedLseek_Sets_status_LessThan_0_Increment_fault_file_seek */

void Test_CF_CFDP_S_SubstateSendMetadata_SecondCallTo_CF_WrappedLseek_Sets_status_ToNot_0_Increment_fault_file_seek(void)
{
    /* Arrange */
    history_t       dummy_history;
    transaction_t   dummy_t;
...
void Test_CF_CFDP_S_SubstateSendMetadata_BypassedFileChecks_t_fd_IsNot_0_CallTo_CF_CFDP_SendMd_Returns_CF_SEND_ERROR_ThenErrorOut(void)
{
    /* Arrange */
    history_t       dummy_history;
    transaction_t   dummy_t;
    ...
    /* Assert CF_CFDP_S_Reset */
    UtAssert_STUB_COUNT(CF_CFDP_ResetTransaction, 1);
} /* end Test_CF_CFDP_S_SubstateSendMetadata_BypassedFileChecks_t_fd_IsNot_0_CallTo_CF_CFDP_SendMd_Returns_CF_SEND_ERROR_ThenErrorOut */

void Test_CF_CFDP_S_SubstateSendMetadata_BypassedFileChecks_t_fd_IsNot_0_CallTo_CF_CFDP_SendMd_Returns_CF_SEND_SUCCESS_Then_sub_state_SetTo_SEND_FILE_DATA(void)
{
    /* Arrange */
    transaction_t   dummy_t;
    transaction_t*  arg_t = &dummy_t;
    ...
    arg_t->state_data.s.sub_state = Any_uint8_Except(SEND_FILEDATA); /* setting sub_state is not required, but it helps verification */
    arg_t->fd = Any_int32_Except(0);
...
} /* end Test_CF_CFDP_S_SubstateSendMetadata_BypassedFileChecks_t_fd_IsNot_0_CallTo_CF_CFDP_SendMd_Returns_CF_SEND_SUCCESS_Then_sub_state_SetTo_SEND_FILE_DATA */

void Test_CF_CFDP_S_SubstateSendMetadata_BypassedFileChecks_t_fd_IsNot_0_CallTo_CF_CFDP_SendMd_Returns_CF_SEND_NO_MSG_DoNotSet_sub_state(void)
{
    /* Arrange */
    transaction_t   dummy_t;
    transaction_t*  arg_t = &dummy_t;
    ...
    arg_t->state_data.s.sub_state = initial_sub_state; /* setting sub_state is not required, but it helps verification */
    arg_t->fd = Any_int32_Except(0);

    UT_SetDataBuffer(UT_KEY(CF_CFDP_SendMd), &context_CF_CFDP_SendMd,
      sizeof(context_CF_CFDP_SendMd), false);
    UT_SetDefaultReturnValue(UT_KEY(CF_CFDP_SendMd), CF_SEND_NO_MSG);
...
} /* end Test_CF_CFDP_S_SubstateSendMetadata_BypassedFileChecks_t_fd_IsNot_0_CallTo_CF_CFDP_SendMd_Returns_CF_SEND_NO_MSG_DoNotSet_sub_state */
...
void Test_CF_CFDP_S_SubstateSendFinAck_WhenCallTo_CF_CFDP_SendAck_Returns_CF_SEND_NO_MSG_DoNotCall_CF_CFDP_S_Reset_(void)
{
    /* Arrange */
    history_t       dummy_history;
    transaction_t   dummy_t;
    ...
    UtAssert_True(context_CF_CFDP_SendAck.dir_code == PDU_FIN,
      "CF_CFDP_SendAck received dir_code %u and should be %u (PDU_FIN)",
      context_CF_CFDP_SendAck.dir_code, PDU_FIN);
    ...
    UtAssert_True(context_CF_CFDP_SendAck.tsn == arg_t->history->seq_num,
      "CF_CFDP_SendAck received tsn %u and should be %u (t->history->seq_num)",
...
void Test_CF_CFDP_S_SubstateSendFinAck_WhenCallTo_CF_CFDP_SendAck_DoesNotReturn_CF_SEND_NO_MSG_Call_CF_CFDP_S_Reset_With_t_AsArgument(void)
{
    /* Arrange */
    history_t       dummy_history;
    transaction_t   dummy_t;
    ...
    context_CF_CFDP_SendAck.forced_return = Any_cfdp_send_ret_t_Except(CF_SEND_NO_MSG);
...
} /* end Test_CF_CFDP_S_SubstateSendFinAck_WhenCallTo_CF_CFDP_SendAck_DoesNotReturn_CF_SEND_NO_MSG_Call_CF_CFDP_S_Reset_With_t_AsArgument */
...
void Test_CF_CFDP_S2_Fin_When_CF_CFDP_RecvFin_Returns_0_Set_fin_cc_And_sub_state(void)
{
    ...
    UtAssert_True(arg_t->state_data.s.sub_state == SEND_SEND_FIN_ACK,
      "sub_state is set to %u and should be %u (SEND_SEND_FIN_ACK)",
...
void Test_CF_CFDP_S2_Nak_CallTo_CF_CFDP_Sets_md_need_send_To_1_When_offset_start_And_offset_end_Are_0_Add_num_sr_To_nak_segment_requests(void)
{
    /* Arrange */
    history_t       dummy_history;
    transaction_t   dummy_t;
    ...
    UtAssert_STUB_COUNT(CF_CFDP_RecvNak, 1);
    UtAssert_STUB_COUNT(CFE_EVS_SendEvent, 0);
    UtAssert_True(CF_AppData.hk.channel_hk[arg_t->chan_num].counters.recv.nak_segment_requests == (uint32)(initial_nak_segment_requests + context_CF_CFDP_RecvNak_forced_num_sr),
      "counter recv nak_segment_requests set to %u and should be %u (num_sr) more than %u (value before call)",
      CF_AppData.hk.channel_hk[arg_t->chan_num].counters.recv.nak_segment_requests, context_CF_CFDP_RecvNak_forced_num_sr, initial_nak_segment_requests);
    UtAssert_True(arg_t->flags.tx.md_need_send == 1,
      "md_need_send set to %u and should be 1",
      arg_t->flags.tx.md_need_send);
} /* end Test_CF_CFDP_S2_Nak_CallTo_CF_CFDP_Sets_md_need_send_To_1_When_offset_start_And_offset_end_Are_0_Add_num_sr_To_nak_segment_requests */
...
void Test_CF_CFDP_S2_Nak_Calls_CF_Chunks_Add_Because_start_Plus_size_IsEqualToTransaction_fsize(void)
{
    ...
    UT_SetDataBuffer(UT_KEY(CF_Chunks_Add), &context_CF_Chunks_Add,
      sizeof(context_CF_Chunks_Add), false);
    ...
    UtAssert_True(context_CF_Chunks_Add.size == dummy_offset_end - dummy_offset_start,
      "CF_Chunks_Add received size %u and should be %u (size)",
      context_CF_Chunks_Add.size, dummy_offset_end - dummy_offset_start);
    UtAssert_STUB_COUNT(CFE_EVS_SendEvent, 0);
...
void Test_CF_CFDP_S2_Nak_Arm_Call_CF_CFDP_ArmAckTimer_And_CF_CFDP_S2_Nak(void)
{
    ...
    UT_SetDataBuffer(UT_KEY(CF_CFDP_ArmAckTimer), &context_CF_CFDP_ArmAckTimer,
      sizeof(context_CF_CFDP_ArmAckTimer), false);
...
void Test_CF_CFDP_S2_WaitForEofAck_CallTo_CF_CFDP_RecvAck_Returns_0_And_t_history_cc_EqTo_CC_NO_ERROR_Set_sub_state_To_SEND_WAIT_FOR_FIN_And_ack_time_armed_To_0(void)
{
    /* Arrange */
    history_t       dummy_history;
    transaction_t   dummy_t;
    ...
    arg_t->state_data.s.sub_state = Any_uint8_Except(SEND_WAIT_FOR_FIN); /* setting sub_state not required, but helps verification */
    ...
    UtAssert_True(arg_t->state_data.s.sub_state == SEND_WAIT_FOR_FIN,
      "sub_state was set to %u and should be %u (SEND_WAIT_FOR_FIN)",
      arg_t->state_data.s.sub_state, SEND_WAIT_FOR_FIN);
    UtAssert_True(arg_t->flags.tx.ack_timer_armed == 0,
      "sub_state was set to %u and should be 0",
      arg_t->flags.tx.ack_timer_armed);
    UtAssert_STUB_COUNT(CFE_EVS_SendEvent, 0);
} /* end Test_CF_CFDP_S2_WaitForEofAck_CallTo_CF_CFDP_RecvAck_Returns_0_And_t_history_cc_EqTo_CC_NO_ERROR_Set_sub_state_To_SEND_WAIT_FOR_FIN_And_ack_time_armed_To_0 */

void Test_CF_CFDP_S2_WaitForEofAck_CallTo_CF_CFDP_RecvAck_Returns_0_And_t_history_cc_NotEqTo_CC_NO_ERROR_Call_CF_CFDP_S_Reset(void)
{
    /* Arrange */
    history_t       dummy_history;
    transaction_t   dummy_t;
    ...
    /* Assert CF_CFDP_S_Reset */
    UtAssert_STUB_COUNT(CF_CFDP_ResetTransaction, 1);
} /* end Test_CF_CFDP_S2_WaitForEofAck_CallTo_CF_CFDP_RecvAck_Returns_0_And_t_history_cc_NotEqTo_CC_NO_ERROR_Call_CF_CFDP_S_Reset */
...
void Test_CF_CFDP_S_DispatchRecv_Asserts_sub_state_LessThan_SEND_NUM_STATES(void)
{
    ...
    // arg_t->state_data.s.sub_state = SEND_NUM_STATES;
...
void Test_CF_CFDP_S_DispatchRecv_DidNotHaveFlagsSetBut_fdh_directive_code_IsEqTo_PDU_INVALID_MAX_SendEventAndIncrement_recv_spurious(void)
{
    /* Arrange */
    history_t       dummy_history;
    pdu_r_msg_t     dummy_msg;
    ...
    ((pdu_r_msg_t*)CF_AppData.engine.in.msg)->ph.flags = dummy_flags;
    ...
    /* Assert */
    UtAssert_True(CF_AppData.hk.channel_hk[dummy_chan_num].counters.recv.spurious == (uint16)(initial_recv_spurious + 1),
    ...
    UtAssert_StrCmp(context_CFE_EVS_SendEvent.Spec, expected_Spec,
      "CFE_EVS_SendEvent received expected Spec\n'%s' - Received\n'%s' - Expected", 
      context_CFE_EVS_SendEvent.Spec, expected_Spec);
} /* end Test_CF_CFDP_S_DispatchRecv_DidNotHaveFlagsSetBut_fdh_directive_code_IsEqTo_PDU_INVALID_MAX_SendEventAndIncrement_recv_spurious */

void Test_CF_CFDP_S_DispatchRecv_DidNotHaveFlagsSetBut_fdh_directive_code_IsGreaterThan_PDU_INVALID_MAX_SendEventAndIncrement_recv_spurious(void)
{
    /* Arrange */
    history_t       dummy_history;
    pdu_r_msg_t     dummy_msg;
    ...
    UtAssert_StrCmp(context_CFE_EVS_SendEvent.Spec, expected_Spec,
      "CFE_EVS_SendEvent received expected Spec\n'%s' - Received\n'%s' - Expected", 
      context_CFE_EVS_SendEvent.Spec, expected_Spec);
} /* end Test_CF_CFDP_S_DispatchRecv_DidNotHaveFlagsSetBut_fdh_directive_code_IsGreaterThan_PDU_INVALID_MAX_SendEventAndIncrement_recv_spurious */

void Test_CF_CFDP_S_DispatchRecv_Received_msg_ph_As_fdh_Has_flags_LessThan_PDU_INVALID_MAX_Call_fns_sub_state_directive_code(void)
{
    /* Arrange */
    pdu_r_msg_t     dummy_msg;
    transaction_t   dummy_t;
    ...
    UtAssert_True(CF_AppData.hk.channel_hk[dummy_chan_num].counters.recv.spurious == initial_recv_spurious,
      ...
      CF_AppData.hk.channel_hk[arg_t->chan_num].counters.recv.spurious, initial_recv_spurious);
    UtAssert_STUB_COUNT(CFE_EVS_SendEvent, 0);
} /* end Test_CF_CFDP_S_DispatchRecv_Received_msg_ph_As_fdh_Has_flags_LessThan_PDU_INVALID_MAX_Call_fns_sub_state_directive_code */
...
**         the method is to run 66 tests (!!!), using each array value and then to setup the test in the way that will run
...
**                   with the expected t (a transaction_t*) and substate_fns (the double array)
**                    
*******************************************************************************/
/* TODO: CF_CFDP_S2_Recv tests should be verifying the array built in the method, but it cannot be done without an extremely large amount of setup, thus there is 1 test that shows it calls CF_CFDP_S_DispatchRecv for coverage purposes */
...
/*******************************************************************************
**
**  CF_CFDP_S1_Tx tests (simple) - no coverage (broken) - [unstubbables: CF_CFDP_S_SubstateSendMetadata, CF_CFDP_S_SubstateSendFileData, CF_CFDP_S1_SubstateSendEof]
...
void Test_CF_CFDP_S1_Tx_Asserts_t_sub_state_IsGreaterThan_SEND_EOF(void)
{
    ...
    /* Act */
    /* Assert */
    UtAssert_MIR("JIRA: GSFCCFS-1733 issue - t->state_data.s.sub_state<=SEND_EOF");
...
//     // /* Arrange unstubbable: CF_CFDP_S1_SubstateSendEof - get back CF_SEND_NO_MSG from CF_CFDP_S_SendEof*/
...
/*******************************************************************************
**
**  CF_CFDP_S2_Tx tests (simple) - full coverage - [unstubbables: CF_CFDP_S_SubstateSendMetadata, CF_CFDP_S2_SubstateSendFileData, CF_CFDP_S2_SubstateSendEof]
**  TODO: only 1 call is needed for coverage, but that does not fully test the behavior
*******************************************************************************/
...
//     /* Arrange unstubbable: CF_CFDP_S2_SubstateSendEof - get back CF_SEND_NO_MSG from CF_CFDP_S_SendEof*/
//     /* Arrange unstubbable: CF_CFDP_S_SendEof -  bypass finalize just return CF_CFDP_SendEof */
//     CF_CFDP_SendEof_context_t   context_CF_CFDP_SendEof;
...
void Test_CF_CFDP_S_Cancel_When_t_sub_state_IsLessThan_SEND_EOF_SetTo_SEND_EOF(void)
{
    ...
    transaction_t   dummy_t;
    transaction_t*  arg_t = &dummy_t;
    uint8           initial_sub_state = Any_uint8_LessThan(SEND_EOF);
    ...
    /* Assert */
    UtAssert_True(arg_t->state_data.s.sub_state == SEND_EOF,
      "t->state_data.s.sub_state is %u and was changed to %u (SEND_EOF) from %u (value before call)",
      arg_t->state_data.s.sub_state, SEND_EOF, initial_sub_state);
...
void Test_CF_CFDP_S_Cancel_When_t_sub_state_IsEqTo_SEND_EOF_DoNothing(void)
{
    ...
    /* Assert */
    UtAssert_True(arg_t->state_data.s.sub_state == SEND_EOF,
      "t->state_data.s.sub_state is %u and is unchanged from %u (SEND_EOF - value before call)",
      arg_t->state_data.s.sub_state, SEND_EOF);
...
void Test_CF_CFDP_S_Cancel_When_t_sub_state_IsGreaterThan_SEND_EOF_DoNothing(void)
{
    ...
    transaction_t   dummy_t;
    transaction_t*  arg_t = &dummy_t;
    uint8           initial_sub_state = Any_uint8_GreaterThan(SEND_EOF);
...
/*******************************************************************************
**
**  CF_CFDP_S_Tick tests (large) - full coverage - [unstubbables: CF_CFDP_S_Reset, CF_CFDP_S_SendEof, CF_CFDP_S_CheckAndRespondNak, CF_CFDP_S_SubstateSendFinAck]
**
*******************************************************************************/
...
void Test_CF_CFDP_S_Tick_When_t_state_IsNotEqTo_CFDP_S2_DoNothing(void)
{
    ...
    arg_t->state = Any_uint8_Except(CFDP_S2);
...
void Test_CF_CFDP_S_Tick_CallTo_CF_TimerExpired_Returns_1_ThenSendsEventAndCalls_CF_CFDP_S_Reset_AndIncrements_inactivity_timer(void)
{
    /* Arrange */
    history_t       dummy_history;
    transaction_t   dummy_t;
    ...
    UT_SetDataBuffer(UT_KEY(CF_Timer_Expired), &context_CF_Timer_Expired,
      sizeof(context_CF_Timer_Expired), false);
    ...
    UtAssert_True(context_CF_CFDP_ResetTransaction.keep_history == 1,
      "CF_CFDP_ResetTransaction received keep_history %d and should be 1",
      context_CF_CFDP_ResetTransaction.keep_history == 1);
} /* end Test_CF_CFDP_S_Tick_CallTo_CF_TimerExpired_Returns_1_ThenSendsEventAndCalls_CF_CFDP_S_Reset_AndIncrements_inactivity_timer */

void Test_CF_CFDP_S_Tick_ArmedTimerExpiredAnd_sub_state_EqTo_SEND_WAIT_FOR_EOF_ACK_AndIncremented_ack_EqTo_ack_limit_SendEventIncrement_ack_limit_ThenCalls_CF_CFDP_S_Reset(void)
{
    /* Arrange */
    cf_config_table_t   dummy_config_table;
    history_t           dummy_history;
    ...
    UT_SetDataBuffer(UT_KEY(CF_Timer_Tick), &context_CF_Timer_Tick,
      sizeof(context_CF_Timer_Tick), false);
    ...
    UtAssert_StrCmp(context_CFE_EVS_SendEvent.Spec, expected_Spec,
      "CFE_EVS_SendEvent received expected Spec\n'%s' - Received\n'%s' - Expected", 
      context_CFE_EVS_SendEvent.Spec, expected_Spec);
    UtAssert_True(CF_AppData.hk.channel_hk[arg_t->chan_num].counters.fault.ack_limit == (uint16)(initial_fault_ack_limit + 1),
    ...
    UtAssert_True(context_CF_CFDP_ResetTransaction.keep_history == 1,
      "CF_CFDP_ResetTransaction received keep_history %d and should be 1",
      context_CF_CFDP_ResetTransaction.keep_history == 1);
} /* end Test_CF_CFDP_S_Tick_ArmedTimerExpiredAnd_sub_state_EqTo_SEND_WAIT_FOR_EOF_ACK_AndIncremented_ack_EqTo_ack_limit_SendEventIncrement_ack_limit_ThenCalls_CF_CFDP_S_Reset */

void Test_CF_CFDP_S_Tick_ArmedTimerExpiredAnd_sub_state_EqTo_SEND_WAIT_FOR_EOF_ACK_AndIncremented_ack_NotEqTo_ack_limit_CallTo_CFDP_S_SendEof_Return_CF_SEND_NO_MSG_CausesErrOut(void)
{
    /* Arrange */
...
void Test_CF_CFDP_S_Tick_ArmedTimerExpiredAnd_sub_state_EqTo_SEND_WAIT_FOR_EOF_ACK_AndIncremented_ack_NotEqTo_ack_limit_CallTo_CFDP_S_SendEof_Returns_CF_SEND_ERROR_Call_CF_CFDP_S_Reset_AndErrOut(void)
{
    /* Arrange */
    ...
    UtAssert_True(context_CF_CFDP_ResetTransaction.keep_history == 1,
      "CF_CFDP_ResetTransaction received keep_history %d and should be 1",
      context_CF_CFDP_ResetTransaction.keep_history == 1);
} /* end Test_CF_CFDP_S_Tick_ArmedTimerExpiredAnd_sub_state_EqTo_SEND_WAIT_FOR_EOF_ACK_AndIncremented_ack_NotEqTo_ack_limit_CallTo_CFDP_S_SendEof_Returns_CF_SEND_ERROR_Call_CF_CFDP_S_Reset_AndErrOut */

void Test_CF_CFDP_S_Tick_ArmedTimerExpiredAnd_sub_state_EqTo_SEND_WAIT_FOR_EOF_ACK_AndIncremented_ack_NotEqTo_ack_limit_CallTo_CFDP_S_SendEof_ReturnsAnythingExcept_CF_SEND_NO_MSG_Or_CF_SEND_ERROR_Call_CF_CFDP_ArmAckTimer(void)
{
    /* Arrange */
...
void Test_CF_CFDP_S_Tick_ArmedTimerExpired_sub_state_NotEqTo_SEND_WAIT_FOR_EOF_ACK_DoNotArmAckOrTick(void)
{
    ...
    uint16              initial_inactivity_timer = Any_uint16();
    uint16              initial_fault_ack_limit = Any_uint16();
    uint8               exceptions[2] = {SEND_WAIT_FOR_EOF_ACK, SEND_SEND_FIN_ACK}; // SEND_SEND_FIN_ACK only excepted for separate behavior 'if' block
    cf_timer_t*         context_CF_Timer_Expired[2];
    cf_timer_t*         context_CF_Timer_Tick;
...
void Test_CF_CFDP_S_Tick_Nak_CallTo_CF_CFDP_S_CheckAndRespondNak_DoesNotReturn_1_Given_cont_ValueNotSet(void)
{
    ...
    transaction_t     dummy_t;
    transaction_t*    arg_t = &dummy_t;
    int               initial_cont = Any_int_Except(1); /* Any_int_Except(1) is not required, but illustrative of the fact that 1 is the value that will be set. The chance of 1 being selected randomly from all possible 'int's is practically nil. */
    ...
    UT_SetDefaultReturnValue(UT_KEY(CF_CFDP_SendMd), CF_SEND_ERROR); /* to err out */
    ...
    UtAssert_True(dummy_cont == initial_cont,
      "After call to CF_CFDP_S_Tick_Nak value at cont is %d and should be %d (value unchanged)",
...
void Test_CF_CFDP_S_Tick_Nak_CallTo_CF_CFDP_S_CheckAndRespondNak_Returns_1_Given_cont_ValueSetTo_1(void)
{
    ...
    UT_SetDefaultReturnValue(UT_KEY(CF_CFDP_SendMd), Any_uint8_Except(CF_SEND_ERROR)); /* to NOT err out */
...
{    
    UtTest_Add(Test_CF_CFDP_S_ResetCall_CF_CFDP_ResetTransaction_with_keep_history, 
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
         "Test_CF_CFDP_S_ResetCall_CF_CFDP_ResetTransaction_with_keep_history");
} /* end add_CF_CFDP_S_Reset_tests */

void add_CFDP_S_SendEof_tests(void)
{     
    UtTest_Add(Test_CFDP_S_SendEof_When_flag_tx_crc_calc_Is_0_Call_CF_CRC_Finalize_AndSet_crc_calc_To_1_ReturnValueOfCallTo_CF_CFDP_SendEof, 
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
...
{          
    UtTest_Add(Test_CF_CFDP_S2_SubstateSendEof_TriggerTickProcessing,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
...
{          
    UtTest_Add(Test_CFDP_S_SendFileData_When_ph_Is_NULL_Return_0,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
         "Test_CFDP_S_SendFileData_When_ph_Is_NULL_Return_0");
    UtTest_Add(Test_CFDP_S_SendFileData_WhenCachedPosNotEq_foffs_CallTo_CF_WrappedLseek_Returns_status_NotEqTo_foffs_SendEventReturn_neg1,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CFDP_S_SendFileData_CallTo_CF_WrappedRead_ReturnsValueNotEqTo_bytes_to_read_SendEventAndReturn_neg1,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
         "Test_CFDP_S_SendFileData_CallTo_CF_WrappedRead_ReturnsValueNotEqTo_bytes_to_read_SendEventAndReturn_neg1");
    UtTest_Add(Test_CFDP_S_SendFileData_Given_bytes_to_read_GreaterThan_outgoing_file_chunk_size_CallTo_CF_WrappedRead_ReturnsValueNotEqTo_bytes_to_read_SendEventAndReturn_neg1,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CFDP_S_SendFileData_CallTo_CF_CFDP_SendFd_Returns_CF_SEND_NO_MSG_Return_0,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CFDP_S_SendFileData_CallTo_CF_CFDP_SendFd_ReturnsDontCareNoCallTo_CF_CRC_Digest_ReturnBytesToRead,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
         "Test_CFDP_S_SendFileData_CallTo_CF_CFDP_SendFd_ReturnsDontCareNoCallTo_CF_CRC_Digest_ReturnBytesToRead");
    UtTest_Add(Test_CFDP_S_SendFileData_CallTo_CF_CFDP_SendFd_ReturnsDontCareWithCallTo_CF_CRC_Digest_ReturnBytesToRead,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
...
void add_CF_CFDP_S_SubstateSendFileData_tests(void)
{
    ...
    UtTest_Add(Test_CF_CFDP_S_SubstateSendFileData_CallTo_CFDP_S_SendFileData_ReturnsGreaterThan_0_Update_t_foffs_NotEq_t_fsize_DoNotSet_sub_state,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_SubstateSendFileData_CallTo_CFDP_S_SendFileData_ReturnsGreaterThan_0_Update_t_foffs_IsEqTo_t_fsize_Set_sub_state_To_SEND_EOF,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_SubstateSendFileData_CallTo_CFDP_S_SendFileData_ReturnsLessThan_0_Set_cc_To_CC_FILESTORE_REJECTION_And_sub_state_To_SEND_EOF,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
...
void add_CF_CFDP_S_CheckAndRespondNak_tests(void)
{
    ...
    UtTest_Add(Test_CF_CFDP_S_CheckAndRespondNak_DoesNothingBecause_CF_CFDP_SendMd_DoesNotReturn_CF_SEND_ERROR_Or_CF_SEND_SUCCESS_Return_1,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_CheckAndRespondNak_CallTo_CF_Chunks_GetFirstChunkReturns_nonNULL_CallTo_CFDP_S_SendFileData_Returns_0_ThenReturn_0,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_CheckAndRespondNak_CallTo_CF_Chunks_GetFirstChunkReturns_nonNULL_CallTo_CFDP_S_SendFileData_ReturnsLessThan_0_ThenReturn_neg1,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_CheckAndRespondNak_CallTo_CF_Chunks_GetFirstChunkReturned_nonNULL_CallTo_CFDP_S_SendFileData_ReturnsGreaterThan_0_ThenReturn_1,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
...
{
    UtTest_Add(Test_CF_CFDP_S2_SubstateSendFileData_CallTo_CF_CFDP_S_CheckAndRespondNak_Returns_0_Call_CF_CFDP_S_SubstateSendFileData,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
         "Test_CF_CFDP_S2_SubstateSendFileData_CallTo_CF_CFDP_S_CheckAndRespondNak_Returns_0_Call_CF_CFDP_S_SubstateSendFileData");
    UtTest_Add(Test_CF_CFDP_S2_SubstateSendFileData_CF_CFDP_S_CheckAndRespondNak_ReturnsNegativeValue_Call_CF_CFDP_S_Reset,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
         "Test_CF_CFDP_S2_SubstateSendFileData_CF_CFDP_S_CheckAndRespondNak_ReturnsNegativeValue_Call_CF_CFDP_S_Reset");
    UtTest_Add(Test_CF_CFDP_S2_SubstateSendFileData_CallTo_CF_CFDP_S_CheckAndRespondNak_ReturnsPositiveValueDoNothing,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
...
{
    UtTest_Add(Test_CF_CFDP_S_SubstateSendMetadata_CallTo_OS_FileOpenCheck_Returns_OS_SUCCESS_Increment_fault_file_open,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
         "Test_CF_CFDP_S_SubstateSendMetadata_CallTo_OS_FileOpenCheck_Returns_OS_SUCCESS_Increment_fault_file_open");
    UtTest_Add(Test_CF_CFDP_S_SubstateSendMetadata_CallTo_CF_WrappedOpen_Makes_fd_LessThan_0_Increment_fault_file_open,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
         "Test_CF_CFDP_S_SubstateSendMetadata_CallTo_CF_WrappedOpen_Makes_fd_LessThan_0_Increment_fault_file_open");
    UtTest_Add(Test_CF_CFDP_S_SubstateSendMetadata_FirstCallTo_CF_WrappedLseek_Sets_status_LessThan_0_Increment_fault_file_seek,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
         "Test_CF_CFDP_S_SubstateSendMetadata_FirstCallTo_CF_WrappedLseek_Sets_status_LessThan_0_Increment_fault_file_seek");
    UtTest_Add(Test_CF_CFDP_S_SubstateSendMetadata_SecondCallTo_CF_WrappedLseek_Sets_status_ToNot_0_Increment_fault_file_seek,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
         "Test_CF_CFDP_S_SubstateSendMetadata_SecondCallTo_CF_WrappedLseek_Sets_status_ToNot_0_Increment_fault_file_seek");
    UtTest_Add(Test_CF_CFDP_S_SubstateSendMetadata_AllFileChecksPassCallTo_CF_CFDP_SendMd_Returns_CF_SEND_ERROR_ThenErrorOut,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
         "Test_CF_CFDP_S_SubstateSendMetadata_AllFileChecksPassCallTo_CF_CFDP_SendMd_Returns_CF_SEND_ERROR_ThenErrorOut");
    UtTest_Add(Test_CF_CFDP_S_SubstateSendMetadata_BypassedFileChecks_t_fd_IsNot_0_CallTo_CF_CFDP_SendMd_Returns_CF_SEND_ERROR_ThenErrorOut,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_SubstateSendMetadata_BypassedFileChecks_t_fd_IsNot_0_CallTo_CF_CFDP_SendMd_Returns_CF_SEND_SUCCESS_Then_sub_state_SetTo_SEND_FILE_DATA,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_SubstateSendMetadata_BypassedFileChecks_t_fd_IsNot_0_CallTo_CF_CFDP_SendMd_Returns_CF_SEND_NO_MSG_DoNotSet_sub_state,
         cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
...
{
    UtTest_Add(Test_CF_CFDP_S_SubstateSendFinAck_WhenCallTo_CF_CFDP_SendAck_Returns_CF_SEND_NO_MSG_DoNotCall_CF_CFDP_S_Reset_,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S_SubstateSendFinAck_WhenCallTo_CF_CFDP_SendAck_Returns_CF_SEND_NO_MSG_DoNotCall_CF_CFDP_S_Reset_");
    UtTest_Add(Test_CF_CFDP_S_SubstateSendFinAck_WhenCallTo_CF_CFDP_SendAck_DoesNotReturn_CF_SEND_NO_MSG_Call_CF_CFDP_S_Reset_With_t_AsArgument,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
...
{
    UtTest_Add(Test_CF_CFDP_S2_EarlyFin_SendEventAndCallReset,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
...
{
    UtTest_Add(Test_CF_CFDP_S2_Fin_When_CF_CFDP_RecvFin_Returns_0_Set_fin_cc_And_sub_state,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S2_Fin_When_CF_CFDP_RecvFin_Returns_0_Set_fin_cc_And_sub_state");
...
void add_CF_CFDP_S2_Nak_tests(void)
{
    ...
    UtTest_Add(Test_CF_CFDP_S2_Nak_CallTo_CF_CFDP_Sets_md_need_send_To_1_When_offset_start_And_offset_end_Are_0_Add_num_sr_To_nak_segment_requests,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S2_Nak_SendsEventBecause_offset_end_IsLessThan_offset_start,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S2_Nak_SendsEventBecause_offset_end_IsLessThan_offset_start");
...
{
    UtTest_Add(Test_CF_CFDP_S2_Nak_Arm_Call_CF_CFDP_ArmAckTimer_And_CF_CFDP_S2_Nak,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S2_Nak_Arm_Call_CF_CFDP_ArmAckTimer_And_CF_CFDP_S2_Nak");
...
void add_CF_CFDP_S2_WaitForEofAck_tests(void)
{
    ...
    UtTest_Add(Test_CF_CFDP_S2_WaitForEofAck_CallTo_CF_CFDP_RecvAck_Returns_0_And_t_history_cc_EqTo_CC_NO_ERROR_Set_sub_state_To_SEND_WAIT_FOR_FIN_And_ack_time_armed_To_0,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S2_WaitForEofAck_CallTo_CF_CFDP_RecvAck_Returns_0_And_t_history_cc_NotEqTo_CC_NO_ERROR_Call_CF_CFDP_S_Reset,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
...
{
    UtTest_Add(Test_CF_CFDP_S_DispatchRecv_Asserts_sub_state_LessThan_SEND_NUM_STATES,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S_DispatchRecv_Asserts_sub_state_LessThan_SEND_NUM_STATES");
    UtTest_Add(Test_CF_CFDP_S_DispatchRecv_Asserts_msg_in_Is_NULL,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S_DispatchRecv_Asserts_msg_in_Is_NULL");
    UtTest_Add(Test_CF_CFDP_S_DispatchRecv_AlreadyHas_pdu_ph_flags_SetSoSendEvent,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S_DispatchRecv_AlreadyHas_pdu_ph_flags_SetSoSendEvent");
    UtTest_Add(Test_CF_CFDP_S_DispatchRecv_DidNotHaveFlagsSetBut_fdh_directive_code_IsEqTo_PDU_INVALID_MAX_SendEventAndIncrement_recv_spurious,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_DispatchRecv_DidNotHaveFlagsSetBut_fdh_directive_code_IsGreaterThan_PDU_INVALID_MAX_SendEventAndIncrement_recv_spurious,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_DispatchRecv_Received_msg_ph_As_fdh_Has_flags_LessThan_PDU_INVALID_MAX_Call_fns_sub_state_directive_code,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S_DispatchRecv_Received_msg_ph_As_fdh_Has_flags_LessThan_PDU_INVALID_MAX_Call_fns_sub_state_directive_code");
    UtTest_Add(Test_CF_CFDP_S_DispatchRecv_Received_msg_ph_As_fdh_Has_flags_LessThan_PDU_INVALID_MAX_But_fns_NULL_DoNothing,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
...
{
    UtTest_Add(Test_CF_CFDP_S1_Recv_SendsAll_NULL_fns_To_CF_CFDP_S_DispatchRecv,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S1_Recv_SendsAll_NULL_fns_To_CF_CFDP_S_DispatchRecv");
} /* end add_CF_CFDP_S1_Recv_tests */

void add_CF_CFDP_S2_Recv_tests(void)
{
    UtTest_Add(Test_CF_CFDP_S2_Recv_Call_CF_CFDP_S_DispatchRecv,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
...
{
    UtTest_Add(Test_CF_CFDP_S1_Tx_Asserts_t_sub_state_IsGreaterThan_SEND_EOF,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S1_Tx_Asserts_t_sub_state_IsGreaterThan_SEND_EOF");
    UtTest_Add(Test_CF_CFDP_S1_Tx_When_t_sub_state_Is_0_Call_CF_CFDP_S_SubstateSendMetadata,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S1_Tx_When_t_sub_state_Is_0_Call_CF_CFDP_S_SubstateSendMetadata");
    /* NOTE: comment tests back in when they are fixed, but coverage does not require Test_CF_CFDP_S1_Tx_When_t_sub_state_Is_1_Call_CF_CFDP_S_SubstateSendFileData or Test_CF_CFDP_S1_Tx_When_t_sub_state_Is_2_Call_CF_CFDP_S1_SubstateSendEof */
...
{
    UtTest_Add(Test_CF_CFDP_S2_Tx_Asserts_t_sub_state_IsGreaterThan_SEND_EOF,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S2_Tx_Asserts_t_sub_state_IsGreaterThan_SEND_EOF");
    UtTest_Add(Test_CF_CFDP_S2_Tx_When_t_sub_state_Is_0_Call_CF_CFDP_S_SubstateSendMetadata,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S2_Tx_When_t_sub_state_Is_0_Call_CF_CFDP_S_SubstateSendMetadata");
    /* NOTE: comment tests back in when they are fixed, but coverage does not require Test_CF_CFDP_S2_Tx_When_t_sub_state_Is_1_Call_CF_CFDP_S_SubstateSendFileData or Test_CF_CFDP_S2_Tx_When_t_sub_state_Is_2_Call_CF_CFDP_S2_SubstateSendEof */
...
{
    UtTest_Add(Test_CF_CFDP_S_Cancel_When_t_sub_state_IsLessThan_SEND_EOF_SetTo_SEND_EOF,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S_Cancel_When_t_sub_state_IsLessThan_SEND_EOF_SetTo_SEND_EOF");
    UtTest_Add(Test_CF_CFDP_S_Cancel_When_t_sub_state_IsEqTo_SEND_EOF_DoNothing,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S_Cancel_When_t_sub_state_IsEqTo_SEND_EOF_DoNothing");
    UtTest_Add(Test_CF_CFDP_S_Cancel_When_t_sub_state_IsGreaterThan_SEND_EOF_DoNothing,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S_Cancel_When_t_sub_state_IsGreaterThan_SEND_EOF_DoNothing");
} /* end add_CF_CFDP_S_Cancel_tests */

void add_CF_CFDP_S_Tick_tests(void)
{
    UtTest_Add(Test_CF_CFDP_S_Tick_When_t_state_IsNotEqTo_CFDP_S2_DoNothing,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S_Tick_When_t_state_IsNotEqTo_CFDP_S2_DoNothing");
    UtTest_Add(Test_CF_CFDP_S_Tick_CallTo_CF_TimerExpired_Returns_1_ThenSendsEventAndCalls_CF_CFDP_S_Reset_AndIncrements_inactivity_timer,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_Tick_ArmedTimerExpiredAnd_sub_state_EqTo_SEND_WAIT_FOR_EOF_ACK_AndIncremented_ack_EqTo_ack_limit_SendEventIncrement_ack_limit_ThenCalls_CF_CFDP_S_Reset,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_Tick_ArmedTimerExpiredAnd_sub_state_EqTo_SEND_WAIT_FOR_EOF_ACK_AndIncremented_ack_NotEqTo_ack_limit_CallTo_CFDP_S_SendEof_Return_CF_SEND_NO_MSG_CausesErrOut,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_Tick_ArmedTimerExpiredAnd_sub_state_EqTo_SEND_WAIT_FOR_EOF_ACK_AndIncremented_ack_NotEqTo_ack_limit_CallTo_CFDP_S_SendEof_Returns_CF_SEND_ERROR_Call_CF_CFDP_S_Reset_AndErrOut,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_Tick_ArmedTimerExpiredAnd_sub_state_EqTo_SEND_WAIT_FOR_EOF_ACK_AndIncremented_ack_NotEqTo_ack_limit_CallTo_CFDP_S_SendEof_ReturnsAnythingExcept_CF_SEND_NO_MSG_Or_CF_SEND_ERROR_Call_CF_CFDP_ArmAckTimer,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
    ...
    UtTest_Add(Test_CF_CFDP_S_Tick_ArmedTimerNotExpiredCall_CF_Timer_Tick,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S_Tick_ArmedTimerNotExpiredCall_CF_Timer_Tick");
    UtTest_Add(Test_CF_CFDP_S_Tick_TimerNotArmedDoNotArmAckTimerOrDoTick,
      cf_cfdp_s_tests_Setup, cf_cfdp_s_tests_Teardown, 
      "Test_CF_CFDP_S_Tick_TimerNotArmedDoNotArmAckTimerOrDoTick");
