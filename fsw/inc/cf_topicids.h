...
#define DEFAULT_CFE_MISSION_CF_CH0_TX_TOPICID 0xC2

#define CFE_MISSION_CF_CH1_TX_TOPICID         CFE_MISSION_CF_TIDVAL(CH1_TX)
#define DEFAULT_CFE_MISSION_CF_CH1_TX_TOPICID 0xC3

#define CFE_MISSION_CF_CH0_RX_TOPICID         CFE_MISSION_CF_TIDVAL(CH0_RX)
#define DEFAULT_CFE_MISSION_CF_CH0_RX_TOPICID 0xC8

#define CFE_MISSION_CF_CH1_RX_TOPICID         CFE_MISSION_CF_TIDVAL(CH1_RX)
#define DEFAULT_CFE_MISSION_CF_CH1_RX_TOPICID 0xC9
